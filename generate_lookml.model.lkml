...
view: schema_table_search {
    sql_table_name: (SELECT table_schema, table_name, column_name, data_type, column_comment FROM INFORMATION_SCHEMA.COLUMNS
 ...
 ;;
  ...
  set: required {
    fields: [column_name, table_schema, table_name, type_convert]
  }
}
